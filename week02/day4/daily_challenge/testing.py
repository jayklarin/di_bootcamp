...
file_path = os.path.join(dir_path, 'unstuck.txt')
...
class Text:
    # The __init__ method should take a string as an argument
    # and store it in an attribute (e.g., self.text).
    ...
    def word_frequency(self, word):
        ...
        occurences = word_list.count(self.word)
        # If the word is not found, return None or a meaningful message.
        if occurences == 0:
            return f"{self.word} is not in the text"
        else:
            # Return the count.
            return occurences
    ...
    def most_common_word(self):
        ...
        for w in word_list:
            frequencey_dict[w] = frequencey_dict.get(w,0) + 1
        # Return the most common word.
        most_common = max(frequencey_dict, key=frequencey_dict.get)
        return most_common
...
t = Text("hello world hello Jay world world")

print(t.word_frequency("hello"))   # -> 2
print(t.word_frequency("python"))  # -> None or message
print(t.most_common_word())        # -> 'world'
print(sorted(t.unique_words()))    # -> ['Jay', 'hello', 'world'] (order may vary)

# Using the file_path you defined earlier
t2 = Text.from_file(file_path)

print(type(t2))       # <class '__main__.Text'>
print(t2.text[:100])  # show first 100 characters of the file
print(t2.most_common_word())
print(len(t2.unique_words()))
